...
class AccountPlePurchaseBook(models.Model):
	...
	_description = 'Account Ple Purchase Book'
	_auto = False
	...
	def init(self):
		...
		self.env.cr.execute('''
			CREATE OR REPLACE VIEW %s AS (
				...
				a1.periodo,a1.fecha_cont,a1.libro,a1.fecha_e,a1.td,a1.serie,a1.numero,''::character varying as estado,
			'' as estado_c, a1.am_id
			from vst_compras_1_1 a1 limit 1
			)''' % (self._table,)
		)
