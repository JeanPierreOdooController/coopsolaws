...
class AccountAssetDepreciationMove(models.TransientModel):
	...
	_description = 'Account Asset Depreciation Move'
	...
	def asset_compute(self):
		...
		asset_move = self.env['account.asset.move.it'].search([('period_id','=',self.period.id),('company_id','=',self.company_id.id)],limit=1)
		if asset_move:
