...
class AccountMove(models.Model):
	...
	campo_32_sale = fields.Boolean(string='Inconsistencia en Tipo de Cambio Venta', default=False)
	campo_33_sale = fields.Boolean(string='Cancelado con Medio de Pago Venta', default=False)
	...
	campo_36_purchase = fields.Boolean(string='Inconsistencia en Tipo de Cambio Compra', default=False)
	...
	campo_40_purchase = fields.Boolean(string='Cancelado con Medio de Pago Compra', default=False)
	...
	campo_12_purchase_nd = fields.Char(string='Serie Compras ND',size=20)
...
class DocInvoiceRelac(models.Model):
	...
	_description = 'Doc Invoice Relac'
