...
class AccountMove(models.Model):
	...
	def _auto_create_asset(self):
		...
		for asset in t:
			...
			asset.partner_id_it = asset.original_move_line_ids[0].move_id.partner_id.id or None
	...
	def _prepare_move_for_asset_depreciation(self, vals):
		...
		t['glosa'] = 'GASTO '+ asset.original_move_line_ids[0].move_id.partner_id.name + ' FT ' + asset.original_move_line_ids[0].move_id.ref if asset.original_move_line_ids else None
		t['line_ids'][0][2]['partner_id'] = asset.original_move_line_ids[0].move_id.partner_id.id if asset.original_move_line_ids else None
		...
		t['line_ids'][0][2]['name'] = 'GASTO '+ asset.original_move_line_ids[0].move_id.partner_id.name + ' FT ' + asset.original_move_line_ids[0].move_id.ref if asset.original_move_line_ids else None
		t['line_ids'][1][2]['partner_id'] = asset.original_move_line_ids[0].move_id.partner_id.id if asset.original_move_line_ids else None
		...
		t['line_ids'][1][2]['name'] = 'GASTO '+ asset.original_move_line_ids[0].move_id.partner_id.name + ' FT ' + asset.original_move_line_ids[0].move_id.ref if asset.original_move_line_ids else None
		return t