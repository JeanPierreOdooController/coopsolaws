...
class AccountExchangeDocumentRep(models.TransientModel):
	...
	_description = 'Account Exchange Document Rep'
	...
	def get_excel(self):
		...
		return self.env['popup.it'].get_file('Diferencia_ME_Documento.xlsx',base64.encodestring(b''.join(f.readlines())))
