...
CREATE OR REPLACE FUNCTION public.get_detalle_pdf_10(
	...
	periodo integer,
	company_id integer)
    RETURNS TABLE(cuenta character varying, nomenclatura character varying, code_bank character varying, account_number character varying, 
    moneda integer, debe numeric, haber numeric, account_id integer) 
    LANGUAGE 'plpgsql'
