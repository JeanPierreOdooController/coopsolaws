odoo.define('ecommerce_select_address_js_it.website_sale', function(require) {
    "use strict";
   ...
   publicWidget.registry.WebsiteSale.include({
     ...
     _changeCountry: function () {
        ...
        this._rpc({
            route: "/shop/country_infos_js/" + $("#country_id").val(),
            params: {
                mode: 'shipping',
            },
        }).then(function (data) {
   ...
   publicWidget.registry.websiteSaleDelivery = publicWidget.Widget.extend({
    ...
    _onChangeDocvat: function () {
      ...
      this._rpc({
            ...
            if (data.state == 'error') {
              ...
              if (dx.zip){
                $('#zip').val(dx.zip).attr('readonly','1');
              }
    ...
    _onChangeState: function () {
        ...
        this._rpc({
            route: "/shop/states_infos_js/" + $("#state_id").val(),
            params: {
                mode: 'shipping',
            },
        }).then(function (data) {
    ...
    _onChangeProvince: function () {
        ...
        this._rpc({
            route: "/shop/province_infos_js/" + $("#province_id").val(),
            params: {
                mode: 'shipping',
            },
        }).then(function (data) {
    ...
    _ChangeZip: function (id) {
        if (!$(id).val()) {
          ...
          this._rpc({
            route: "/shop/district_js/" + $("#district_id").val(),
            params: {
                mode: 'shipping',
            },
        }).then(function (data) {
            if(data){
               $('input[name="zip"]').val(data).attr('readonly','1');
