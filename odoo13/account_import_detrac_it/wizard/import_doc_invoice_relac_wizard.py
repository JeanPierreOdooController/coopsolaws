...
class ImportDocInvoiceRelacWizard(models.TransientModel):
	_name = 'import.doc.invoice.relac.wizard'
	_description = 'Import Doc Invoice Relac Wizard'
	...
	def add_doc_relac_move(self, values):
		...
		doc = self.env['einvoice.catalog.01'].search([('code','=','01')],limit=1)
