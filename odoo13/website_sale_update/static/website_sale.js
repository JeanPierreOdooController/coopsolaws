...
publicWidget.registry.websiteSaleCart = publicWidget.Widget.extend({
    ...
    events: {
        ...
        'click .js_change_invoice': '_onClickChangeInvoice',        
    ...
    _onClickChangeInvoice: function (ev) {
        var $old = $('.all_invoice').find('.card.border.border-primary');
        $old.find('.btn-invoice').toggle();
        $old.addClass('js_change_invoice');
        $old.removeClass('border border-primary');

        var $new = $(ev.currentTarget).parent('div.one_kanban').find('.card');
        $new.find('.btn-invoice').toggle();
        $new.removeClass('js_change_invoice');
        $new.addClass('border border-primary');
