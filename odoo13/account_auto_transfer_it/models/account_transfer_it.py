...
class AccountTransferIt(models.Model):
	...
	_description = 'Account Transfer IT'
	...
	def _check_percent(self):
		...
		if round(total_percent,3) != 100:
			raise UserError('La suma de todas las lineas de distribucion tiene que ser 100%%! la suma es %s'%(str(round(total_percent,3))))
...
class AccountTransferAccountLine(models.Model):
	...
	_description = 'Account Transfer Account Line'
...
class AccountTransferDistributionLine(models.Model):
	...
	_description = 'Account Transfer Distribution Line'
