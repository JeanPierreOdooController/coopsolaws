...
class AccountAssetAsset(models.Model):
	...
	def set_move_check(self):
		...
		sql_update = """update account_asset_depreciation_line set move_check = false, move_id=null, move_posted_check=false where asset_id = %s""" % (str(self.id))
	...
	def compute_depreciation_board(self):
		...
		commands = [(2, line_id.id, False) for line_id in self.depreciation_line_ids]
