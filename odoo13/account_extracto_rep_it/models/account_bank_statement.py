...
class AccountBankStatement(models.Model):
	...
	def generate_excel(self):
		...
		HEADERS = ['FECHA','DESCRIPCION','PARTNER','REFERENCIA','MEDIO DE PAGO','MONTO','CONCILIADO']
		...
		for line in self.line_ids:
			...
			worksheet.write_number(x,5,line.amount if line.amount else 0,formats['numberdos'])
			worksheet.write(x,6,'SI' if line.journal_entry_ids else 'NO',formats['especial1'])
