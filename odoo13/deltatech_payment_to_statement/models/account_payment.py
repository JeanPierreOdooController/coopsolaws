...
class AccountPayment(models.Model):
	...
	statement_id = fields.Many2one(
		"account.bank.statement", string="Extracto", domain="[('journal_id','=',journal_id)]"
	)

	statement_destination_id = fields.Many2one(
		"account.bank.statement", string="Extracto Destino", domain="[('journal_id','=',destination_journal_id)]"
	)
