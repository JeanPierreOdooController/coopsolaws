...
class MainParameter(models.Model):
	...
	dt_national_credit_note = fields.Many2one('einvoice.catalog.01',string=u'Tipo de Documento NC')
	...
	interest_account_leasing = fields.Many2one('account.account',string=u'Cuenta Interes 1')
	...
	accrue_seat_journal_leasing = fields.Many2one('account.journal',string=u'Diario Asiento Devengo 1')
	...
	interest_account_loan = fields.Many2one('account.account',string=u'Cuenta Interes 2')
	...
	accrue_seat_journal_loan = fields.Many2one('account.journal',string=u'Diario Asiento Devengo 2')
	...
	dt_perception = fields.Many2one('einvoice.catalog.01',string=u'Tipo de Documento Percepción')
	...
	exchange_difference = fields.Boolean(string='Diferencia de Cambio Globales', default=False)
...
class CurrencyParameterLine(models.Model):
	...
	_description = 'Currency Parameter Line'
